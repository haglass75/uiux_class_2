<template>
  <div class="home">
    ...
    <div class="product-list">
      <div @click="viewPdoductDetails(pro)" v-for="(pro, index) in products" :key="index" class="card">
        <h3>{{ pro.name }}</h3>
...
.home {
  ...
  .product-list {
    ...
    .card {
      flex: 1;
      text-align: center;
      background-color: rgb(203, 216, 227);
      ...
      .button {
        &.primary {
          @include button-style(#3498db); // 파랑 버튼
        }
        &.secondary {
          @include button-style(#e74c3c); // 빨강 버튼
        }
      }
    }
  }
